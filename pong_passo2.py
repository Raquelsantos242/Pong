#----------------------------------------------------------
#PASSO 2: Desenhar os elementos do jogo, o fundo, as paletas e a bola
#----------------------------------------------------------
...
PALETAOFFSET = 20    #distância da paleta até a extremidade da tela
...
def desenhaArena():
    ...
    pygame.draw.line(DISPLAYSURF, VERMELHO, ((LARGURA_TELA//2),0),((LARGURA_TELA//2),ALTURA_TELA), (LARGURA_LINHA//4))
...
def main():
    ...
    # ** --------------------------------------------------------
    #Cria os Rects para as 2 paletas e para a bola e os coloca na posição inicial
