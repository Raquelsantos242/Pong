#----------------------------------------------------------
#PASSO 7: verificar colisão da bola com paletas
#----------------------------------------------------------
...
def desenhaBola(bola):
    pygame.draw.rect(DISPLAYSURF, VERMELHO, bola)
...
def verificaColisaoBola(bola, paleta1, paleta2, bolaDirX):
    if bolaDirX == -1 and paleta1.right == bola.left and paleta1.top < bola.bottom and paleta1.bottom > bola.top:
        return -1
